...
class MainActivity : AppCompatActivity() {
    ...
    private fun onGenerateButtonClicked()
    {
        try {
            ...
            /*
                single scheduler:
                single bir scheduler'dan bir tane çalıştırılabilir. Diğer single scheduler'lar bir diğeri
                bittikten sonra çalıştırılır. Executors sınıfının newSingleThreadExecutor metodunu
                hatırlayınız
            */
