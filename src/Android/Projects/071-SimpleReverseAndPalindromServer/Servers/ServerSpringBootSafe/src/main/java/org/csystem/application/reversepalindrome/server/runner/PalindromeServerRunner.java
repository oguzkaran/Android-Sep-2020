...
public class PalindromeServerRunner implements ApplicationRunner {
    ...
    private final Map<Integer, ClientInfo> m_clients;
    ...
    private void palindromeSchedulerCallback()
    {
        ...
        synchronized (m_clients) {
            m_clients.keySet()
                    .removeIf(key -> SchedulerUtil.isRemovable(key, m_clients, m_schedulerThreshold, m_thresholdUnitStr));
        }
    }
    ...
    public PalindromeServerRunner(
            ...
            @Qualifier("palindromeClientsMap") Map<Integer, ClientInfo> clients)
    {
