/*----------------------------------------------------------------------------------------------------------------------
    TODO: AnalyticalCircleF sınıfı
----------------------------------------------------------------------------------------------------------------------*/
package org.csystem.util.math.geometry

open class AnalyticalCircleF(radius: Double = 0.0, x: Int = 0, y: Int = 0) : Circle(radius) {
    ...
    fun radiusDistance(analyticalCircle: AnalyticalCircleF) = mCenter.distance(analyticalCircle.mCenter)
}